...
import { Check, Gamepad2, BrainCircuit, ShieldCheck } from "lucide-react";
  ...
  return (
    <section className="relative min-h-[90vh] w-full overflow-hidden bg-cream bg-dot-pattern flex flex-col items-center justify-center pt-20">
      ...
      <div className="z-30 text-center max-w-4xl px-4 flex flex-col items-center gap-6">
        ...
        >
          Meet <span className="font-bold text-rose-500">Rotten Mochi</span>. The AI coach that verifies your kid's chores & homework before unlocking their device.
        </motion.p>
        ...
        >
          <Button size="lg" className="bg-rose-500 hover:bg-rose-600 text-white rounded-full px-8 py-6 text-lg shadow-rose-200 shadow-lg cursor-pointer">
            Start Parent Mode
          </Button>
          <Button size="lg" variant="outline" className="rounded-full px-8 py-6 text-lg border-slate-200 text-slate-600 hover:bg-slate-50 cursor-pointer">
            How it works
          </Button>
        </motion.div>
      </div>
        ...
        <Card className="bg-white/95 backdrop-blur-md shadow-2xl rounded-3xl p-4 border-slate-100">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-xs text-green-600 font-medium">Verification Complete</p>
            </div>
          </div>
      ...
      >
        <Card className="bg-white shadow-xl rounded-2xl p-5 border-slate-100 rotate-3">
          <div className="flex justify-between items-center mb-4">
            ...
            <Badge className="bg-green-100 text-green-700 hover:bg-green-100 shadow-none">UNLOCKED</Badge>
          </div>
