...
const sections = [
	...
	{
		title: 'Use of Face Data',
		paragraphs: [
			'Face data is used solely for real-time task verification within the app. For example, it allows the app to determine whether a required action (such as smiling) has been completed in order to unlock screen time.',
			'Face data is not used for identification, analytics, profiling, advertising, or training machine learning models.',
		],
	},
	{
	...
	{
		title: 'Face Data Sharing',
		paragraphs: [
			'We do not share face data with any third parties. Face data is not sold, rented, or disclosed to external organizations.',
		],
	},
	{
	...
	},
	{
		...
		paragraphs: [
			'Face data is processed temporarily and is not stored.',
			'Facial images are used only during the verification process and are deleted immediately after processing (typically within a few seconds). No face data is retained on our servers or systems.',
		],
	},
	{
